// 메뉴 객체 배열
const menuItems1 = [
    { image: 'img/buger1.png', name: '1955 버거', price: '1,000원' },
    { image: 'img/buger2.png', name: '더블 불고기', price: '2,000원' },
    { image: 'img/buger3.png', name: '빅맥', price: '3,000원' },
    { image: 'img/buger4.png', name: '베이컨 토마토 디럭스', price: '4,000원' },
    { image: 'img/buger5.png', name: '슈비 버거', price: '5,000원' }
];

const menuItems2 = [
    { image: 'img/bugerking1.png', name: '와퍼', price: '2,000원' },
    { image: 'img/bugerking2.png', name: '트리플 머쉬룸', price: '3,000원' },
    { image: 'img/bugerking3.png', name: '몬스터 와퍼', price: '4,000원' },
    { image: 'img/bugerking4.png', name: '두툼버거', price: '5,000원' },
    { image: 'img/bugerking5.png', name: '통새우 와퍼', price: '6,000원' }
];
...
function RandomLunchImage() {
    ...
    document.getElementById('randomPrice').textContent = `가격: ${randomMenu.price}`;
